...
1.3 กดปุ่ม <img src="../add_icon.png" style="display: inline-block;" /> ระบบจะแสดงหน้า A/R Invoice
...
2.4 กดปุ่ม <img src="../copy_icon.png" style="display: inline-block;" /> ด้านบนขวามือ
...
3.1 คลิกเข้าสู่ Account Receivable Module

3.2 เลือกฟังก์ชัน Invoice จะเข้าสู่หน้า A/R Invoice list

3.3 กดปุ่ม <img src="../add_icon.png" style="display: inline-block;" /> ระบบจะแสดงหน้า A/R Invoice
...
3.11 ให้กดปุ่ม <img src="../edit_icon.svg" style="display: inline-block;" /> ด้านหน้ารายการ ระบบจะแสดงหน้าต่างให้แก้ไขข้อมูล
...
<img src="../add_icon.png" style="display: inline-block;" /> สร้างใบแจ้งหนี้ใหม่

<img src="../edit_icon.png" style="display: inline-block;" /> แก้ไขใบแจ้งหนี้ (เมื่อยังไม่ approve หรือ รับชำระแล้ว หรือ ยกเลิกแล้ว หรืออยู่ใน period ที่ปิดไปแล้ว)

<img src="../void_icon.png" style="display: inline-block;" /> การยกเลิกใบแจ้งหนี้ (เมื่อยังไม่ approve หรือ รับชำระแล้ว หรืออยู่ใน period ที่ปิดไปแล้ว)

<img src="../copy_icon.png" style="display: inline-block;" /> การคัดลอกใบแจ้งหนี้

<img src="../print_icon.png" style="display: inline-block;" /> การพิมพ์ใบแจ้งหนี้

<img src="../print_voucher_icon.png" style="display: inline-block;" /> การพิมพ์เอกสารบันทึกบัญชีใบแจ้งหนี้

<img src="../receipt_icon.png" style="display: inline-block;" /> การตรวจสอบเอกสารชำระเงินที่ได้รับชำระเงินจากใบแจ้งหนี้ใบที่เปิดอยู่

<img src="../send_email_icon.png" style="display: inline-block;" /> การส่งใบแจ้งหนี้ไปยังลูกหนี้ในช่องทาง Email (ต้องมีการตั้งค่าก่อนเริ่มใช้งาน)
