...
- **Account Receivable - Receipt - Fix Bugs Invoice number not running properly**

  - **Note :** fix bugs for invoice number not running properly when unmark "Auto"
...
- **Account Payable - Payment - Fix Bug to Not allow posting to GL if payment not approved yet**

  - **Note :** If implementing workflow for payment, System will not post transactions to GL if payment not approved
