...
### Account Payable - Report - New feature to export Aging detail as excel compatible

- Note : New feature to export aging detail to excel with align column
- From : Account Payable > Report > Aging Detail 
...
### Asset – Pre-Register Asset – Add function for Void and Un-Void

- Note : Allow to void un use Pre-Register Asset and Un-void for mistaken void
- From : Asset > Pre-Register Asset
...
### AddIn - Improve performance for Update GL History process for transaction with dimensions

- Note : Add In improve performance for Update GL History process to reduce time consuming
- From : Carmen AddIn
